...
<head>
        ...
        <meta name="author" content="David Alfonso GinÃ©s Prieto, Miguel Hita Vicente y Miguel Ãngel MelÃ³n PÃ©rez">
                                ...
                                <div class="nav navbar-nav navbar-right">
                                        <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                        ...
                                                        <li class="divider"></li>
                                                        <li><a href="../home/personalData.php">ConfiguraciÃ³n personal</a></li>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-9 scrollable" role="main">
                                        ...
                                        <?php
                                                ...
                                                /***************  AquÃ­ comienza el bloque que permite mostrar el formulario  ***************/
                                                else{
                            ...
                            $files_dir = $_SERVER['DOCUMENT_ROOT'] . "/cvs/".$editedCVRow['userLogin']."/";
                                                        echo '<fieldset id="auto0">';
                                                                echo '<form id="editedCV" class="form-horizontal" role="form" name="editedCV" method="post" action=editCurCV.php">';
                                                                        ...
                                                                        echo "</div>";
                                                                        echo "<div class='form-group'>";
                                                                                echo "<label class='control-label col-xs-12 col-sm-2'>Tipo de direcciÃ³n</label>";
                                                                                echo "<div class='col-xs-12 col-sm-6'>";
                                                                                        echo "<input class='form-control' type='text' name='eCCVaddrtype' disabled value='" . $editedCVRow['addrType'] . "'>";
                                                                                echo "</div>";
                                                                        echo "</div>";
                                                                        echo "<div class='form-group'>";
                                                                                echo "<label class='control-label col-xs-12 col-sm-2'>Nombre direcciÃ³n</label>";
                                                                                echo "<div class='col-xs-12 col-sm-6'>";
                                                                                        echo "<input class='form-control' type='text' name='eCCVaddrName' disabled value='" . $editedCVRow['addrName'] . "'>";
                                                                                echo "</div>";
                                                                        echo "</div>";
                                                                        echo "<div class='form-group'>";
                                                                                echo "<label class='control-label col-xs-12 col-sm-2'>NÃºmero</label>";
                                                                                echo "<div class='col-xs-12 col-sm-6'>";
                                                                        ...
                                                                        echo "</div>";
                                                                        echo "<div class='form-group'>";
                                                                                echo "<label class='control-label col-xs-12 col-sm-2'>CÃ³digo Postal</label>";
                                                                                echo "<div class='col-xs-12 col-sm-6'>";
                                                                        ...
                                                                        echo "</div>";
                                                                        echo "<div class='form-group'>";
                                                                                echo "<label class='control-label col-xs-12 col-sm-2'>PaÃ­s</label>";
                                                                                echo "<div class='col-xs-12 col-sm-6'>";
                                                                                        echo "<input class='form-control' type='text' name='eCCVcountry' disabled value='" . $editedCVRow['country'] . "'>";
                                                                                echo "</div>";
                                                                        echo "</div>";
                                                                        echo "<div class='form-group'>";
                                                                                echo "<label class='control-label col-xs-12 col-sm-2'>TelÃ©fono Fijo</label>";
                                                                                echo "<div class='col-xs-12 col-sm-6'>";
                                                                                        echo "<input class='form-control' type='text' name='eCCVphone' disabled value='" . $editedCVRow['phone'] . "'>";
                                                                                echo "</div>";
                                                                        echo "</div>";
                                                                        echo "<div class='form-group'>";
                                                                                echo "<label class='control-label col-xs-12 col-sm-2'>TelÃ©fono MÃ³vil</label>";
                                                                                echo "<div class='col-xs-12 col-sm-6'>";
                                                                                        echo "<input class='form-control' type='text' name='eCCVmobile' disabled value='" . $editedCVRow['mobile'] . "'>";
                                                                                echo "</div>";
                                                                        echo "</div>";
                                                                        echo "<div class='form-group'>";
                                                                                echo "<label class='control-label col-xs-12 col-sm-2'>Correo ElectrÃ³nico</label>";
                                                                                echo "<div class='col-xs-12 col-sm-6'>";
                                                                        ...
                                                                        echo "</div>";
                                                                        echo "<div class='form-group'>";
                                                                                echo "<label class='control-label col-xs-12 col-sm-2'>FormaciÃ³n</label>";
                                                                                echo "<div class='col-xs-12 col-sm-6'>";
                                                                                        echo "<input class='form-control' type='text' name='eCCV___' disabled value='" . $editedCVRow['sons'] . "'>";
                                                                                echo "</div>";
                                                                        echo "</div>";
                                                                        ...
                                                                        echo "<div class='form-group'>";
                                                                                ...
                                                                                $file=$files_dir.$value;
                                                                                echo "<a href=downloadFileSingle.php?doc=".$file.">$value</a><br>";
                                                                                }
                                                                                }
                                                                                echo "</div>";
                                                                        echo "</div>";
                                                                        ...
                                                                        //Al guardarlo tendrÃ© que cambiar su 'cvStatus' a 'checked'
                                                                echo '</form>';
